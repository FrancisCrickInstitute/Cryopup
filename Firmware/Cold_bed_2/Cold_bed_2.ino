...
void loop()
{
  ...
  while(sp <= c2 && sp < 19) // while the temperature is higher than the setpoint Heat extraction ON and Peltier ON
  {
      sp = knob.read()*0.125;
      c = thermocouple.readCelsius();
      c2 = thermocouple2.readCelsius();
...
//      Serial.print(",");
  ...
  while(sp > c2 && sp < 19) // while the temperature is lower than the setpoint Heat extraction ON and Peltier OFF
  {
      sp = knob.read()*0.125;
      c = thermocouple.readCelsius();
      c2 = thermocouple2.readCelsius();
...
//      Serial.print(",");
  ...
  while(sp <= c2 && sp >= 19) // while the temperature is lower than the setpoint Heat extraction OFF and Peltier OFF
  {
      sp = knob.read()*0.125;
      c = thermocouple.readCelsius();
      c2 = thermocouple2.readCelsius();
...
//      Serial.print(",");
  ...
  while(sp > c2 && sp >= 19) // while the temperature is lower than the setpoint Heat extraction OFF and Peltier ON (Low PWM value)
  {
      sp = knob.read()*0.125;
      c = thermocouple.readCelsius();
      c2 = thermocouple2.readCelsius();
